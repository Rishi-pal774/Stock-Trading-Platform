...
function ProductsPage() {
  return ( 
    ...
    <RightImage imageUrl="media/images/kiteconnect.png" productName="Kite Connect API" productDescription="Build powerful trading platforms and experiences with our super simple HTTP/JSON APIs. If you are a startup, build your investment app and showcase it to our clientbase." learnMore="Kite Connect"/>

    <LeftImage imageUrl="media/images/varsity.png" productName= "Versity mobile" productDescription="An easy to grasp, collection of stock market lessons with in-depth coverage and illustrations. Content is broken down into bite-size cards to help you learn on the go." tryDemo="" learnMore="" googlePlay="" appStore=""/>

    <p className='text-center mt-5 p-4'>Want to know more about our technology stack? Check out the <a href='@' style={{textDecoration: "none"}}>Zerodha.tech</a> blog.</p>
    <Universe />
