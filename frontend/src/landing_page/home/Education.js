...
function Education() {
  return ( 
     <div className='container m-5'>
      <div className='row'>
        <div className='col-4'>
          <img src='media/images/education.svg' alt='' style={{width: "80%"}}/>
        </div>
       ...
       <div className='col-2'></div>
        <div className='col-6'>
           ...
           <p>Varsity, the largest online stock market education book in the world covering everything from basics to advanced trading.</p>
            ...
            <p className='mt-5'>TradingQ&A, the most active trading and investment community in India for all your market related</p>
